...
function mostrar(empleados) {
    empleados.forEach(e =>{
        resultados += ` <tr>
                            ...
                            <td class="text-center">${e.id_puesto}</td> 
...
//Carga lista de clientes registrados
    ...
    fetch("http://localhost:8000/api/puestosRegistrados/")
        ...
        .then(data => {
            ...
            data.forEach((optionData) => {
                ...
                opcion.text = optionData.id_puesto;
...
//Comparación de nombre seleccionada con a cédula al que corresponde
puesto.addEventListener('change', (e) => {
    puestoSelec = e.target.value; // Valor seleccionado del cliente
    console.log(puestoSelec);
    //idcedula.value = clienteSelec;
});
...
on(document, 'click', '.btnEditar', e => {
    ...
    const fechaIForm = fila.children[6].innerHTML;
