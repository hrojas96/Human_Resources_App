...
class Vacaciones_UsrController {
    ...
    consultarVacacionesUsr(req, res) {
        ...
        accesos.consultarVacacionesUsr(id_empleado,(error, resultado) => {
            if (error) {
        ...
        try{
            ...
            if (filas.length <= 0){
                ...
                if (cant_dias_solicitados <= diasDisponibles){
                    ...
                    accesos.insertarVacacionesUsr(data, (error, resultado) => {
        ...
        try{
            ...
            if (filas.length <= 0){
                ...
                if (cant_dias_solicitados <= diasDisponibles){
                    ...
                    accesos.editarVacacionesUsr(inicio_vacacion, final_vacacion, cant_dias_solicitados, decision_jefatura, decision_RRHH, id_vacaciones, (error, resultado) => {
    ...
    eliminarVacacionesUsr(req,res) {
        let id_vacaciones = req.params.id_vacaciones;
        accesos.eliminarVacacionesUsr(id_vacaciones, (error, resultado) => {
            if (error) {
                console.log('Hubo un error', error);
